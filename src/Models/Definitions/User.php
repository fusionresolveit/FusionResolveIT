...
class User
{
  ...
  {
    $t = [
      'name'                => pgettext('user parameter', 'Login'),
      'id'                  => pgettext('global', 'Id'),
      'lastname'            => pgettext('user parameter', 'Last name'),
      'firstname'           => pgettext('user parameter', 'First name'),
      'is_active'           => pgettext('global', 'Active'),
      'begin_date'          => pgettext('user parameter', 'Valid since'),
      'end_date'            => pgettext('user parameter', 'Valid until'),
      ...
      'registration_number' => pgettext('user parameter', 'Administrative number'),
      'category'            => pgettext('user parameter', 'Category'),
      'comment'             => npgettext('global', 'Comment', 'Comments', 2),
      'title'               => pgettext('user parameter', 'Title'),
      'location'            => npgettext('global', 'Location', 'Locations', 1),
      'profile'             => pgettext('profile', 'Default profile'),
      'defaultgroup'        => pgettext('user parameter', 'Default group'),
      'entity'              => pgettext('user parameter', 'Default entity'),
      'supervisor'          => pgettext('user parameter', 'Responsible'),
      'user_dn'             => pgettext('LDAP parameter', 'User DN'),
      'is_deleted_ldap'     => pgettext('LDAP parameter', 'Deleted user in LDAP directory'),
      'personal_token'      => pgettext('user parameter', 'Personal token'),
      'api_token'           => pgettext('user parameter', 'API token'),
      'sync_field'          => pgettext('user parameter', 'Synchronization field'),
      'synchronized_at'     => pgettext('user parameter', 'Last synchronization'),
      'last_login'          => pgettext('user parameter', 'Last login'),
      'updated_at'          => pgettext('global', 'Last update'),
      'created_at'          => pgettext('global', 'Creation date'),
      'completename'        => pgettext('global', 'Complete name'),
      'new_password'        => pgettext('user parameter', 'New password'),
      'new_password_verif'  => pgettext('user parameter', 'New password (verification)'),
    ];
  ...
  public static function getRelatedPages(string $rootUrl): array
  {
    return [
      ...
      [
        'title' => npgettext('user parameter', 'Authorization', 'Authorizations', 2),
        'icon' => 'user lock',
        'link' => $rootUrl . '/authorization',
      ],
      [
        'title' => npgettext('global', 'Group', 'Groups', 2),
        'icon' => 'users',
        'link' => $rootUrl . '/groups',
      ],
      [
        'title' => pgettext('global', 'Settings'),
        'icon' => 'caret square down outline',
        'link' => '',
      ],
      [
        'title' => pgettext('user', 'Used items'),
        'icon' => 'caret square down outline',
        'link' => '',
      ],
      [
        'title' => pgettext('user', 'Managed items'),
        'icon' => 'caret square down outline',
        'link' => '',
      ],
      [
        'title' => pgettext('ticket', 'Created tickets'),
        'icon' => 'caret square down outline',
      ...
      [
        'title' => pgettext('user', 'Synchronization'),
        'icon' => 'caret square down outline',
        'link' => '',
      ],
      [
