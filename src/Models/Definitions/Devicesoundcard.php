...
class Devicesoundcard
{
  public static function getDefinition(): DefinitionCollection
  {
    ...
    $defColl->add(new Def(12, $t['type'], 'input', 'type', fillable: true));
    $defColl->add(new Def(
      13,
      $t['model'],
      'dropdown_remote',
      'model',
      dbname: 'devicesoundcardmodel_id',
      itemtype: '\App\Models\Devicesoundcardmodel',
      fillable: true
    ));
  ...
  public static function getRelatedPages(string $rootUrl): array
  {
    return [
      [
        'title' => npgettext('global', 'Sound card', 'Sound cards', 1),
        'icon' => 'home',
        'link' => $rootUrl,
      ],
      [
