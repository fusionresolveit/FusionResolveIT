...
class Devicesimcard
{
  public static function getDefinition(): DefinitionCollection
  {
    $t = [
      ...
      'allow_voip' => pgettext('inventory device', 'Allow VOIP'),
    ...
    $defColl->add(new Def(
      ...
      'dropdown_remote',
      'type',
      dbname: 'devicesimcardtype_id',
      itemtype: '\App\Models\Devicesimcardtype',
      fillable: true
    ));
    $defColl->add(new Def(12, $t['voltage'], 'input', 'voltage', fillable: true));
    $defColl->add(new Def(14, $t['allow_voip'], 'boolean', 'allow_voip', fillable: true));
