...
class Networkequipment
{
  ...
  public static function getDefinition(): DefinitionCollection
  {
    $t = [
      ...
      'ram' => sprintf(
        ...
        pgettext('inventory device', 'Memory size'),
        pgettext('global', 'Mio')
      ),
    ...
    $defColl->add(new Def(14, $t['ram'], 'input', 'ram', fillable: true));
    $defColl->add(new Def(
      32,
      $t['network'],
      'dropdown_remote',
  ...
  public static function getRelatedPages(string $rootUrl): array
  {
    return [
      [
        'title' => npgettext('global', 'Network device', 'Network devices', 1),
        'icon' => 'home',
        'link' => $rootUrl,
      ],
      [
      ...
      [
        'title' => npgettext('global', 'Network name', 'Network names', 2),
        'icon' => 'caret square down outline',
        'link' => '',
      ],
      [
