...
class Devicecontrol
{
  public static function getDefinition(): DefinitionCollection
  {
    $t = [
      ...
      'is_raid' => pgettext('inventory device', 'RAID'),
    ...
    $defColl->add(new Def(12, $t['is_raid'], 'boolean', 'is_raid', fillable: true));
    $defColl->add(new Def(
      14,
      $t['interface'],
      'dropdown_remote',
    ...
    $defColl->add(new Def(
      ...
      'dropdown_remote',
      'model',
      dbname: 'devicecontrolmodel_id',
      itemtype: '\App\Models\Devicecontroltype',
      fillable: true
    ));
  ...
  public static function getRelatedPages(string $rootUrl): array
  {
    return [
      [
        'title' => npgettext('global', 'Controller', 'Controllers', 1),
        'icon' => 'home',
        'link' => $rootUrl,
      ],
      [
