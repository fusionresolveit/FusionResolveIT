...
class Networkequipment extends Common
{
  ...
  {
    return $this->belongsTo(\App\Models\Networkequipmenttype::class, 'networkequipmenttype_id');
  }

  /** @return BelongsTo<\App\Models\Networkequipmentmodel, $this> */
  public function model(): BelongsTo
  {
    return $this->belongsTo(\App\Models\Networkequipmentmodel::class, 'networkequipmentmodel_id');
  }
