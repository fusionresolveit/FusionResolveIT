...
class PostEnclosuremodel extends Post
{
  /** @var ?string */
  public $name;
  ...
  {
    $this->loadRights('App\Models\Enclosuremodel');
    $enclosuremodel = new \App\Models\Enclosuremodel();
    $this->definitions = $enclosuremodel->getDefinitions();
  ...
  /**
   * @return array{name?: string, product_number?: string, weight?: int, required_units?: int,
   *               depth?: float, power_connections?: int, power_consumption?: int, is_half_rack?: bool,
   *               comment?: string}
   */
  ...
  /**
   * @param-out array{name?: string, product_number?: string, weight?: int, required_units?: int,
   *                  depth?: float, power_connections?: int, power_consumption?: int, is_half_rack?: bool,
   *                  comment?: string} $data
   */
