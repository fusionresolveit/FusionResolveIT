...
class PostPdumodel extends Post
{
  /** @var ?string */
  public $name;
  ...
  {
    $this->loadRights('App\Models\Pdumodel');
    $pdumodel = new \App\Models\Pdumodel();
    $this->definitions = $pdumodel->getDefinitions();
   ...
   *               power_connections?: int, is_half_rack?: bool, comment?: string}
   */
   ...
   *                  power_connections?: int, is_half_rack?: bool, comment?: string} $data
   */
