...
class PostPdu extends Post
{
  ...
  /** @var ?\App\Models\Pdutype */
  public $type;

  /** @var ?\App\Models\Pdumodel */
  public $model;
  ...
  {
    $this->loadRights('App\Models\Pdu');
    $pdu = new \App\Models\Pdu();
    $this->definitions = $pdu->getDefinitions();
    ...
    {
      $type = \App\Models\Pdutype::where('id', $data->type)->first();
      if (!is_null($type))
      {
        $this->type = $type;
      }
      ...
      {
        $emptyType = new \App\Models\Pdutype();
        $emptyType->id = 0;
        $this->type = $emptyType;
      } else {
    ...
    {
      $model = \App\Models\Pdumodel::where('id', $data->model)->first();
      if (!is_null($model))
      {
        $this->model = $model;
      }
      ...
      {
        $emptyModel = new \App\Models\Pdumodel();
        $emptyModel->id = 0;
   ...
   *               type?: \App\Models\Pdutype, model?: \App\Models\Pdumodel,
