...
final class Linetype extends Common implements \App\Interfaces\Crud
{
  ...
  public function newItem(Request $request, Response $response, array $args): Response
  {
    ...
    \App\v1\Controllers\Toolbox::addSessionMessage('The line type has been created successfully');
  ...
  public function updateItem(Request $request, Response $response, array $args): Response
  {
    ...
    \App\v1\Controllers\Toolbox::addSessionMessage('The line type has been updated successfully');
  ...
  public function deleteItem(Request $request, Response $response, array $args): Response
  {
    ...
    if ($linetype->trashed())
    {
      ...
      \App\v1\Controllers\Toolbox::addSessionMessage('The line type has been deleted successfully');
      ...
      $linetype->delete();
      \App\v1\Controllers\Toolbox::addSessionMessage('The line type has been soft deleted successfully');
    }
  ...
  public function restoreItem(Request $request, Response $response, array $args): Response
  {
    ...
    if ($linetype->trashed())
    {
      ...
      $linetype->restore();
      \App\v1\Controllers\Toolbox::addSessionMessage('The line type has been restored successfully');
    }
