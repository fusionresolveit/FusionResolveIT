...
final class Blacklist extends Common implements \App\Interfaces\Crud
{
  ...
  public function newItem(Request $request, Response $response, array $args): Response
  {
    ...
    \App\v1\Controllers\Toolbox::addSessionMessage('The backlist has been created successfully');
  ...
  public function updateItem(Request $request, Response $response, array $args): Response
  {
    ...
    \App\v1\Controllers\Toolbox::addSessionMessage('The blacklist has been updated successfully');
  ...
  public function deleteItem(Request $request, Response $response, array $args): Response
  {
    ...
    if ($blacklist->trashed())
    {
      ...
      \App\v1\Controllers\Toolbox::addSessionMessage('The blacklist has been deleted successfully');
      ...
      $blacklist->delete();
      \App\v1\Controllers\Toolbox::addSessionMessage('The blacklist has been soft deleted successfully');
    }
  ...
  public function restoreItem(Request $request, Response $response, array $args): Response
  {
    ...
    if ($blacklist->trashed())
    {
      ...
      $blacklist->restore();
      \App\v1\Controllers\Toolbox::addSessionMessage('The blacklist has been restored successfully');
    }
