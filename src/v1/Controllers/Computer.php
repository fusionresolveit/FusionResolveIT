...
final class Computer extends Common
{
  ...
  public function showVolumes(Request $request, Response $response, $args): Response
  {
    global $translator;
  ...
  public function showVirtualization(Request $request, Response $response, $args): Response
  {
    global $translator;
  ...
  function checkAndReplaceProperty($item, $field, $strToReplace, $new_link, $replaceByBr = false)
  {
    $ret = $new_link;
