...
final class Contact extends Common implements \App\Interfaces\Crud
{
  ...
  public function newItem(Request $request, Response $response, array $args): Response
  {
    ...
    \App\v1\Controllers\Toolbox::addSessionMessage('The contact has been created successfully');
  ...
  public function updateItem(Request $request, Response $response, array $args): Response
  {
    ...
    \App\v1\Controllers\Toolbox::addSessionMessage('The contact has been updated successfully');
  ...
  public function deleteItem(Request $request, Response $response, array $args): Response
  {
    ...
    if ($contact->trashed())
    {
      ...
      $contact->forceDelete();
      \App\v1\Controllers\Toolbox::addSessionMessage('The contact has been deleted successfully');
      ...
      $contact->delete();
      \App\v1\Controllers\Toolbox::addSessionMessage('The contact has been soft deleted successfully');
    }
  ...
  public function restoreItem(Request $request, Response $response, array $args): Response
  {
    ...
    if ($contact->trashed())
    {
      ...
      $contact->restore();
      \App\v1\Controllers\Toolbox::addSessionMessage('The contact has been restored successfully');
    }
