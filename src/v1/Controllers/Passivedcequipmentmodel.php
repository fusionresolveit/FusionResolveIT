...
final class Passivedcequipmentmodel extends Common implements \App\Interfaces\Crud
{
  ...
  public function newItem(Request $request, Response $response, array $args): Response
  {
    ...
    \App\v1\Controllers\Toolbox::addSessionMessage('The passivedcequipment model has been created successfully');
  ...
  public function updateItem(Request $request, Response $response, array $args): Response
  {
    ...
    \App\v1\Controllers\Toolbox::addSessionMessage('The passivedcequipment model has been updated successfully');
  ...
  public function deleteItem(Request $request, Response $response, array $args): Response
  {
    ...
    if ($passivedcequipmentmodel->trashed())
    {
      ...
      \App\v1\Controllers\Toolbox::addSessionMessage('The passivedcequipment model has been deleted successfully');
      ...
      \App\v1\Controllers\Toolbox::addSessionMessage('The passivedcequipment model has been soft deleted successfully');
    }
  ...
  public function restoreItem(Request $request, Response $response, array $args): Response
  {
    ...
    if ($passivedcequipmentmodel->trashed())
    {
      ...
      \App\v1\Controllers\Toolbox::addSessionMessage('The passivedcequipment model has been restored successfully');
    }
