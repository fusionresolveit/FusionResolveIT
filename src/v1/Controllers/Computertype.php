...
final class Computertype extends Common implements \App\Interfaces\Crud
{
  ...
  public function newItem(Request $request, Response $response, array $args): Response
  {
    ...
    \App\v1\Controllers\Toolbox::addSessionMessage('The computer type has been created successfully');
  ...
  public function updateItem(Request $request, Response $response, array $args): Response
  {
    ...
    \App\v1\Controllers\Toolbox::addSessionMessage('The computer type has been updated successfully');
  ...
  public function deleteItem(Request $request, Response $response, array $args): Response
  {
    ...
    if ($computertype->trashed())
    {
      ...
      \App\v1\Controllers\Toolbox::addSessionMessage('The computer type has been deleted successfully');
      ...
      $computertype->delete();
      \App\v1\Controllers\Toolbox::addSessionMessage('The computer type has been soft deleted successfully');
    }
  ...
  public function restoreItem(Request $request, Response $response, array $args): Response
  {
    ...
    if ($computertype->trashed())
    {
      ...
      \App\v1\Controllers\Toolbox::addSessionMessage('The computer type has been restored successfully');
    }
