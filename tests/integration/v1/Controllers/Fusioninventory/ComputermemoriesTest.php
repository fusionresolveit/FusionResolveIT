...
final class ComputermemoriesTest extends TestCase
{
  ...
  public function testType(): void
  {
    ...
    $this->assertGreaterThan(0, $items[0]->memorymodule->devicememorytype_id);
    $type = \App\Models\Devicememorytype::find($items[0]->memorymodule->devicememorytype_id);
  ...
  public function testTwoMemories(): void
  {
    ...
    $this->assertGreaterThan(0, $items[1]->memorymodule->devicememorytype_id);
    $type = \App\Models\Devicememorytype::find($items[1]->memorymodule->devicememorytype_id);
    ...
    $this->assertGreaterThan(0, $items[2]->memorymodule->devicememorytype_id);
    $type = \App\Models\Devicememorytype::find($items[2]->memorymodule->devicememorytype_id);
    ...
    // TODO
    // must have 3 attached to slot and 1 not attached
  }
