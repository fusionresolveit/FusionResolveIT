...
/**
 * @covers \App\Models\Definitions\Knowledgebasearticlerevision
 ...
 */
final class KnowledgebasearticlerevisionTest extends Common
{
  protected $className = 'Knowledgebasearticlerevision';
}
