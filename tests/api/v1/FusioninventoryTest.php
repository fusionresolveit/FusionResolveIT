...
';
  ...
  public function testSendInventoryNoBIOS(): void
  {
    \App\Models\Computer::truncate();
...
';
  ...
  public function testSendInventoryNoHARDWARE(): void
  {
    \App\Models\Computer::truncate();
...
<REQUEST>
  ...
  <QUERY>INVENTORY</QUERY>
    ...
    $xml = @simplexml_load_string((string) $response->getBody());
    $this->assertNotFalse($xml, 'answer not XML format');
    $this->assertEquals('Data not right, missing HARDWARE/NAME element', $xml->ERROR);
    $this->assertEquals(
      'application/xml',
      $response->getHeaderLine('Content-Type'),
      'Response content-type must be application/xml'
  ...
  public function testSendInventoryNoHARDWARENAME(): void
  {
    \App\Models\Computer::truncate();
...
<REQUEST>
  ...
  public function testSendInventoryHARDWAREEmptyNAME(): void
  {
    \App\Models\Computer::truncate();
